...
func newRouter() http.Handler {
	...
	router.HandleFunc("/api/coupons/{id:[0-9]+}", handlers.GetCouponHandler).Methods("GET")
	router.HandleFunc("/api/coupons/{id:[0-9]+}", handlers.UpdateCouponHandler).Methods("PUT")
